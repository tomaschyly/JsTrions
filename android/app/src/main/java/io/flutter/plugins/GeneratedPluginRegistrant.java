...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.tomaschyly.tch_common_widgets.TchCommonWidgetsPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin tch_common_widgets, com.tomaschyly.tch_common_widgets.TchCommonWidgetsPlugin", e);
    }
    try {
